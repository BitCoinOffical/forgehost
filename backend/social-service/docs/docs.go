...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateCommentDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/social/posts/{post_id}/comments/{comment_id}/like": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/social/posts/{post_id}/comments/{comment_id}/report": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ReportCommentDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/social/profile/{user_id}/report": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID пользователя, на которого жалуемся",
                        "name": "user_id",
                        "in": "path",
                        "required": true
                    },
        ...
        "/social/profile/{user_id}/subscribe": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/social/profile/{user_id}/subscribers": {
            "get": {
        ...
        "/social/profile/{user_id}/subscriptions": {
            "get": {
        ...
        "/social/profile/{user_id}/unsubscribe": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
